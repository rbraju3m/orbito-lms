...
| **Content** *(P16)* | leads and blog posts (built); pages of blocks (written, not yet committed) | **`LeadCaptured`**, **`PostPublished`** |
...
Notification, Analytics, Gamification, Live, and Content — leads and the blog (P16); the page builder is written and not yet committed.
**Still empty:** AI (P17).
