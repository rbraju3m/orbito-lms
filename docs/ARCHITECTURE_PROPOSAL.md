...
| **Content** *(P16)* | leads and blog posts (built); pages of blocks (built) | **`LeadCaptured`**, **`PostPublished`** |
...
Notification, Analytics, Gamification, Live, and Content — leads, the blog and the page builder (P16).
**Still empty:** AI (P17).
